...
<div class="container">
	<div class="row" id="contenu">
		<div class="col-md-12" id="breadcrums">
			<p><a href="{{url('/home')}}">Accueil</a> > <a href="{{url('/dashboard')}}">Profil administrateur</a></p>
		</div>
	</div>
	...
	<div class="col-md-7 designBox dashboard">
		<div class="row">
			...
			<div class="col-md-4">
				<a href="{{url('/addDomain')}}"><button type="submit" class="btn btn-primary btnBox"><img src="{{ asset('assets/img/addDom.png') }}" alt="logo" class="imgBtn"><p>Ajouter domaine</p></button></a>
...
<div class="container">
	<div class="row" id="contenu">
		<div class="col-md-12" id="breadcrums">
			<p><a href="{{url('/home')}}">Accueil</a> > <a href="{{url('/dashboard')}}">Profil Expert</a></p>
		</div>
	</div>
	<div class="col-md-7 designBox dashboard">
		<div class="row">
			...
			<ul class="lienArticle">
				...
				<li><strong>{{$questionNoAnswer->questionUser->nickname}}</strong> a posé une question
					<a href="{{url('/dashboard/answers/'.$questionNoAnswer->id)}}"><div><button type="button" class="btn btn-xs expertAnswerTo">Répondre</button></div></a>
				</li>
			...
			<ul class="lienArticle">
				...
				<li><a href="{{url('/domain/'.$questionAnswered->domain->id.'/question/'.$questionAnswered->id)}}">
		...
		<div class="col-md-7 designBox dashboard">
			<div class="row">
				...
				<ul class="answeredQuestions">
					...
					<li class="answeredQuestion"><a class="ans" href="{{url('/domain/'.$question->domain->id.'/question/'.$question->id)}}">{{$question->content}}</a></li>
					@endforeach
					@endif
				...
				<ul class="myTopics">
					...
					<li><a href="{{url('/domain/'.$topic->domain->id.'/discussion/'.$topic->id)}}">{{$topic->name}}</a></li>
					@endforeach
					@endif
